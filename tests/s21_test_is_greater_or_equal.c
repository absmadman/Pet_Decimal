...
START_TEST(is_greater_or_equal_test_1) {
  ...
  res = s21_is_greater_or_equal(dc1, dc2);
...
Suite *s21_is_greater_or_equal_suite(void) {
  Suite *s;
  s = suite_create("s21_is_greater_or_equal_suite");
  ...
  tcase_add_test(tc_core, is_greater_or_equal_test_3);
  tcase_add_test(tc_core, is_greater_or_equal_test_4);
  tcase_add_test(tc_core, is_greater_or_equal_test_5);
